...
export default function Planner({ onBack }) {
    ...
    if (loading) return (
        <div style={{ minHeight: '100vh', background: 'var(--sand)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--ink)', fontFamily: "'Playfair Display', serif", fontSize: '1.2rem' }}>
            Conectando... ✈️
        </div>
    )
